{{--<div class="mx-auto w-full px-4 sm:px-6 lg:px-8 fixed bottom-0">--}}
{{--    <div class="py-16">--}}
...
{{--        </nav>--}}
{{--    </div>--}}
{{--    <div class="flex flex-col items-center border-t border-slate-400/10 py-10 sm:justify-between text-center">--}}
...
{{--                </svg>--}}
{{--            </a></div>--}}
{{--        <p class="mt-6 text-sm text-slate-500 sm:mt-0 text-center">Copyright © 2022 工具匠 All rights reserved.</p></div>--}}
{{--</div>--}}
...
<footer class="p-4 bg-white rounded-lg md:px-6 md:py-8 dark:bg-gray-900">
    ...
    <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2022 <a href="{{url('/')}}" class="hover:underline">Jason.z</a> 版权所有. | <a href="{{url('sitemap.xml')}}" class="hover:underline">网站地图</a>
    </span>
    <span class="block text-sm mt-2 text-center text-gray-500 dark:text-gray-400"><a href="https://beian.miit.gov.cn" target="_blank">浙ICP备16002143号-1</a></span>
</footer>

<a href="#"  id="back-to-top-btn" class="hidden back-to-top fixed text-lg rounded-full z-10 bottom-5 right-5 h-9 w-9 text-center bg-blue-600 text-white leading-9 block"><i class="uil uil-arrow-up"></i></a>
